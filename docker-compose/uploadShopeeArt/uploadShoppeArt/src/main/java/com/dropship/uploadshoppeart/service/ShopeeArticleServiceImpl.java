...
public class ShopeeArticleServiceImpl extends CommonClient implements ShopeeArticleService {
  ...
  private HttpEntity getCreateArtEntity(ShoppeArticle shopeeArticle) {
    ...
    String formatedRequest = request.replace("$ARTICLE_NAME", "tui nu deo cheo nguc 2").replace("$ARTICLE_DESCRIPTION", "tui nu deo nguctui "
        + "nu deo nguctui nu deo nguctui nu deo nguctui nu deo nguctui nu"
